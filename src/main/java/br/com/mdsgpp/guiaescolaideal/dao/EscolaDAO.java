...
public class EscolaDAO {
    ...
    // Metodo para pesquisar determinada escola por ID no banco
    ...
    // Metodo para pesquisar por campos informados
    ...
    // Metodo para adicionar condicao ao Query
    ...
    // Metodo para pesquisar escolas pelo CEP
    ...
    // Metodo para atualizar votos em determinada escola
	...
	stmt.close();
    	...
    	/**
    	 * Metodo para verificar se a lista de escolas recebidas da 
    	 * consulta esta vazia ou nao
    	 */
    ...
    // Metodo para pegar a lista de escolas retornadas
    ...
    // Metodo para retornar configuracao do Statement 
    ...
    // Metodo para pesquisar escola por nome e localizacao
    ...
    //Metodo para Gerar o query de nome e localizacao
    ...
    // Metodo de adicionar condicao ao query por lista
    ...
    // Metodo para pegar determinada escola 
    ...
    // Metodo para adquirir outras informacoes de determinada escola
    ...
    //Metodo para adquiri informacao dos numeros de determinada escola
    ...
    // Metodo para adquirir informacao da Estrutura Fisica de determinada escola
    ...
    // Metodo para adquirir infomacao sobre o tipo da escola
    ...
    /** Metodo para adquirir informacao da data de inicio do periodo
     * letivo de determinada escola
    */
    ...
    // Metodo para adquirir infomacao basica de determinada escola
