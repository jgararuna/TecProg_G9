...
public class EquipamentoDAO {
	...
	// Metodo para pesquisar determinado equipamento por ID
	...
	// Metodo para pegar determinado equipamento de determinada escola
	...
	// Metodo para pesquisar equipamentos por escola
