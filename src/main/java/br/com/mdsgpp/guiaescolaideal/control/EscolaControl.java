...
public class EscolaControl {
    ...
    public List<Escola> getEscolaIdeal(List<Campo> campos) throws SQLException,ParseException, PesquisaException {
	...
	try {
	    ...
	    listaPalavrasMunicipio = ConversorDeEntrada.getPalavrasChaveDoTexto(nomeMunicipio);
