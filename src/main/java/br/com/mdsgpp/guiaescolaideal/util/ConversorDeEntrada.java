...
public class ConversorDeEntrada {
    ...
    public static int getNumeroInteiro( String numero )
	    throws EntradaDadosException{
	try{
	    return Integer.parseInt( numero );
	}
	catch( NumberFormatException e ){
	    throw new EntradaDadosException( "Formato de n�mero inv�lido!" );
	}
    }
	...
	if ( ( !Util.textoTemConteudo( cep, 8 ) )
	    ...
	    throw new EntradaDadosException( "CEP inv�lido" );
	}
    }
